...
public class KnapsackGeneticInfoTask extends AnimationTimer {
    ...
    public KnapsackGeneticInfoTask(KnapsackTabController knapsackTabController) {
    ...
    protected void redraw(Map<String, String> info) {
        knapsackTabController.updateGeneticInfo(info);
    }
