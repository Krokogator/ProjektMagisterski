...
public class KnapsackBacktrackInfoTask extends AnimationTimer {
    private final AtomicReference<Map<String, String>> info = new AtomicReference<>(null);
    private final KnapsackTabController knapsackTabController;

    public KnapsackBacktrackInfoTask(KnapsackTabController knapsackTabController) {
    ...
    protected void redraw(Map<String, String> info) {
        knapsackTabController.updateBackInfo(info);
    }
